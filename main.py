...
known_button.config(image=right_button_img, highlightthickness=0, command=is_known)
known_button.grid(column=0, row=1)

unknown_button = Button()
wrong_button_img = PhotoImage(file="images/wrong.png")
unknown_button.config(image=wrong_button_img, highlightthickness=0, command=next_card)
